...
{ 
  ...
  if (fromEnt.balance < amount && fromEnt.id !== bank.id ) return res.status(400).json({ error: 'Entity lacks the financial power!' });
...
{ 
  ...
  if (region === 'UK' || region === 'Germany/Netherlands/Switzerland')
  {
	price = 40;
  } else if (region === 'France/Belgium' || region === 'Austria-Hungary')
  {
	price = 20;
  } else {
	price = 10;
